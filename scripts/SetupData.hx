...
class SetupData
{
    ...
    public function new()
    {
        ...
        if (FileSystem.exists("export/windows")) outputPaths.push("export/windows/export/");
        if (FileSystem.exists("export/macOS")) outputPaths.push("export/macOS/export/");
        if (FileSystem.exists("export/hl")) outputPaths.push("export/hl/export/");
        if (FileSystem.exists("export/neko")) outputPaths.push("export/neko/export/");
        if (FileSystem.exists("export/server")) outputPaths.push("export/server/");
        //setup linux later
