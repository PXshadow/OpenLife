...
class ServerSettings {
	...
	public static var TemperatureInWaterFactor:Float = 2;
	...
	public static var SeasonBiomeChangeChancePerYear:Float = 5; // X means it spreads X tiles per year in average in each direction
