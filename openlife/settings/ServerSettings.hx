...
class ServerSettings {
	...
	public static var SendMoveEveryXTicks = 90; // -1 // default 90 // set negative to deactive. if MaxDistanceToBeConsideredAsClose it might be deactivated
	public static var MaxDistanceToBeConsideredAsClose = 40; // 20; // only close players are updated with PU Movement
	...
	private static function LimitTransitionsIfTooMuchOfObject() {
		...
		LimitTransitionIfMaxReached(33, 245, 264, 6);
	...
	private static function LimitTransitionsIfTooFewOfObject() {
		...
		LimitTransitionIfMinNotReached(560, 575, 575, 5); // Allow to kill Sheep if enough
		// Knife 560 +  Shorn Domestic Sheep 576
		LimitTransitionIfMinNotReached(560, 576, 576, 3); // Allow to kill Sheep if enough
