...
class TransitionData
{
    ...
    public function traceTransition(s:String = "", forceTrace = false, smalTrace = true)
    {
      ...
      if(forceTrace == false && dontTraceActor && dontTraceTarget && transition.actorID != ServerSettings.traceTransitionByActorId && transition.targetID != ServerSettings.traceTransitionByTargetId && transition.newActorID != ServerSettings.traceTransitionByNewActorId && transition.newTargetID != ServerSettings.traceTransitionByNewTargetId) return;
