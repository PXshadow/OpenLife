...
pub fn compute_hit_reputation_with_factors(
    ...
    let mut attacker_lost = if is_higher { damage * 0.5 } else { damage };
    ...
    // Haxe L4525: count as ally if exile happened not long ago — **RECENT-EXILE-ALLY** on `is_ally`
...
///
/// Independent of prestige class and economy trade prestige.
...
impl ReputationBook {
    ...
    pub fn apply_hit_delta(&mut self, attacker: i32, target: i32, delta: &HitReputationDelta) {
...
mod tests {
    ...
    fn reputation_is_negative_lost_combat() {
        ...
        assert_eq!(label_from_reputation(25.0), label_from_lost_combat(-25.0));
    }
    ...
    fn format_query_and_remove() {
        ...
        assert!(
            q.contains("label=good") || q.contains("label=fairly_good"),
            "{q}"
        );
    ...
    fn prestige_cost_category_child_and_gm_text() {
        ...
        let msg =
            format_prestige_cost_global_message(d.prestige_cost, d.prestige_cost_category, "Kid")
                .expect("msg");
    ...
    fn prestige_cost_category_ally_and_gm_text() {
        ...
        let msg =
            format_prestige_cost_global_message(d.prestige_cost, d.prestige_cost_category, "Buddy")
                .expect("msg");
    ...
    fn prestige_cost_live_non_ally_factor_overrides_ceil() {
        ...
        assert_eq!(
            elderly.prestige_cost_category,
            PrestigeCostCategory::Elderly
        );
        ...
        assert_eq!(
            rel.prestige_cost_category,
            PrestigeCostCategory::CloseRelative
        );
