...
use crate::bloody::{
    ...
    weapon_bloody_time_to_change, weapon_bloody_time_to_change_ex, BloodyWeaponTransform,
    BLOODY_WEAPON_STRIKE_BASE_TTC, WEAPON_COOLDOWN_FACTOR, WEAPON_COOLDOWN_FACTOR_IF_WOUNDING,
};
use crate::wound_desc::{
...
pub fn moskito_damage_factor(loves_jungle: f32, yellowfever_count: f32, health_factor: f32) -> f32 {
...
pub fn resolve_weapon_zero_transition(
    ...
    if let Some(tr) = content.find_transition_prefer(weapon_id, 0, true) {
        return Some(WeaponZeroTransition {
            ...
            prefer_last_use: tr.last_use_actor
                || content.find_transition_last_use(weapon_id, 0).is_some(),
        });
    }
    None
}
...
pub fn plan_animal_zero_residual_ex(
    ...
    let ttc = base * animal_zero_cooldown_factor_ex(long_wounding, normal_factor, wounding_factor);
    AnimalZeroResidual {
        from_object_id,
...
pub fn bloody_weapon_from_zero_transition_ex(
    ...
    if content_new_actor != 0 && content_new_actor != held_id {
        ...
        let ttc =
            weapon_bloody_time_to_change_ex(base, long_wounding, normal_factor, wounding_factor);
...
mod tests {
    ...
    fn snake_shoes_shift_threshold() {
        ...
        assert!((effective_wound_factor(0.5, 560, true) - 0.5).abs() < 1e-6);
    }
    ...
    fn resolve_weapon_zero_prefer_last_use() {
        ...
        db.transitions.insert((560, 0), bare_tr(560, 0, 750, 797));
    ...
    fn animal_zero_boar_equips_hog_cut_and_transforms() {
        ...
        db.objects.insert(
            ...
            ObjectDef::empty(ATTACKING_WILD_BOAR_ID),
        );
    ...
    fn animal_zero_snake_shoes_and_no_transition_wolf() {
        ...
        db.objects.insert(
            ...
            ObjectDef::empty(ATTACKING_RATTLE_SNAKE_ID),
        );
        ...
        db.auto_decays.insert(ATTACKING_RATTLE_SNAKE_ID, {
    ...
    fn wound_bleed_id_prefers_held_wound() {
        assert_eq!(wound_object_id_for_bleed(true, 797, Some(798)), Some(797));
        assert_eq!(wound_object_id_for_bleed(false, 33, Some(797)), Some(797));
