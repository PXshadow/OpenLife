...
- eating lovely mushrooms give some protection against fever 
...
High priority:
- AI FIX eating super meh if not starving to death
- AI FIX Null poiner bug in Ai.dotime but where???
- AI FIX feeding / do on other ==> could not find target player
...
- ANIMALS fix they wont sometimes display as moving

- MAP fix map creation objects too close
...
- BIOME biome boni for different biome specialists like harvesting more banana for brown TODO: White and Ginger missing
