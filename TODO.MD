...
Killing / Attacking
- you can attack anybody if close in weapon range
- each hit makes certain damage
...
- Coins decay 0.1% per year if >= 1000 coins
- On death your kids will inherit yor coins
...
- EXHAUSTION better indoor reduction
