...
- player heals with time but beeing injured doubles food use
- Heal only if not starving, too cold or hot, or wounded
...
- a child inherits the cravings from his gradma / mother in case there is none // TODO consider father
...
- FIX Full Portable Water Source <394>
- NAMING fix bug
