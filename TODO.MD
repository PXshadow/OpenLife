...
Not yet implemented:
- advaned AI
- incarnation acording to prestige score
- advaned stuff is not tested yet, so may or may not work
- ally gates / giving ownership to others / fences
- curses
- saving of players on server restart. 
    Server restart should only take some seconds, so player should be able to continue once implemented
...
- Your prestiege / health influences your aging and max food pipes and therefore speed
- Your prestiege is also your health displayed where the YUM-Multiplier was.
...
- You get extra score if you feed one YUM or if a follower / (grand) child gets some score
...
Killing / Attacking
- you can attack anybody if target is terrifed, angry or in kill mode
- you get angry / terrifed 10 seconds after attacking / beingattacked
...
- you will loose prestige for attacking a close relative
- you will loose even more prestige for attacking an ally
...
- MESSAGE send one message at a time

- COMBAT animal interactions / collisions
- COMBAT ill from moskitos
- COMBAT block movement if other player is hostile 

- ALLY allow only one new follower at a time
- ALLY fear emote if no weapon and no ally
- ALLY change ally color if leader changes
- ALLY Add coolup time before you can attack first time
- ALLY give support if in angry or posse mode
- ALLY block pickup if hostile player is close
- ALLY change ally status after X seconds???

- BIRTH spawn eves on different locations
- BIRTH fathers
- BIRTH fathers displayed in name (needs workaround since not supported from client)
- BIRTH incarnation according to score
- BIRTH curse system replaced through grave system / in short if your old body is rottening nearby you have a hard time
...
- SCORE calculate real score after grandkids are dead
- SCORE save lineages
- SCORE give score boni like for great clothing

- TEMPERATURE indoor temperature calculation 

- WINTER change snow biome / snow banks / melting if snow

- TOOLS learning tools (hold wrong if not learned)
...
- GATES fences / gates giving to others
- GATES visitor at gate

- COMMANDS implement missing commands 
