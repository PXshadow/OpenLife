...
Adam / Eve:
- adam / Eve use 20% less food
- adam / Eve do 20% less damage
- adam / Eve receive 20% less damage (also from animals)
...
- you gain extra exhaustion in not loved biomes and loose extra exhaustion in loved ones
- TODO differen loved food
...
- eating YUM / Cravings increases Health / Prestige, while eating MEH reduces it (YUM +1 CARAVING: +2 (or more) MEH: -0.5 SUPERMEH: -1)
...
- food value is reduced minus one for each eaten / food has at least half the food value
    For example Berry Default 2: 5 YUM / 4 YUM / 3 YUM / 2 MEH / 1 SUPERMEH / 1 SUPERMEH / 1 SUPERMEH / 1 SUPERMEH ...
- if you eat YUM 1 pip is restored with a 0.8% chance from a random eaten food. 
...
High priority:
- AI fix child run away bug when it tries to craft something while hungry instead of going to mother
- AI drop made stuff after ordered in fronts of player
...
- BABAY change to insteant feeding

- ILL allow ill to eat

- BIOME remove bad biome exhaustion for staying but add for doing stuff in bad biome

- MOVE fix jump forward not backward... 
- MOVE fix jump also if exhausted but maybe not so far... 

- ANIMALS fix they wont sometimes not display as moving

- BIRTH spawn eves on different locations
- BIRTH fathers

- DISPLAY give hints about yellow fever and when its over
- DISPLAY fix display of prestiege gain, coins 
- DISPLAY give hints for crafting
- DISPLAY give hints where other players are
...
- BIOME give biome experience for staying in biome
- BIOME biome boni for different biome specialists
...
emacs -nw filename
rm -r dir1 // to remove a directory like if you want to delete the SaveFiles folder so that the server creates all new 
